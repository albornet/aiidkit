...
def get_donor_cause_of_death(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    ...
    valid_categories = ["CHE", "ANX", "CTR", "CDI", "SUI", "CTU", "Other", "Not applicable"]
...
def get_transplantation_type(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "tpxtype", ["Right", "Left", "Double"])

def get_had_blood_transfusion_event(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "ec", ["Yes", "No"])

def get_had_pregnancy_event(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "ss", ["Yes", "No"])
...
def get_hbs_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "hbsag", ["Positive", "Negative"])

def get_antibody_for_hbs_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antihbs", ["Positive", "Negative"])

def get_antibody_for_hbc_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antihbc", ["Positive", "Negative"])

def get_antibody_for_hcv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antihcv", ["Positive", "Negative"])

def get_antibody_for_cmv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "anticmv", ["Positive", "Negative"])

def get_antibody_for_ebv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antiebv", ["Positive", "Negative"])

def get_antibody_for_hiv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antihiv", ["Positive", "Negative"])

def get_antibody_for_toxo_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antitoxo", ["Positive", "Negative"])

def get_antibody_for_vzv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antivzv", ["Positive", "Negative"])

def get_antibody_for_hsv_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "antihsv", ["Positive", "Negative"])

def get_antibody_for_trep_antigen(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "tpha", ["Positive", "Negative"])
...
def get_hbs_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donhbsag", ["Positive", "Negative"])

def get_antibody_for_hbs_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantihbs", ["Positive", "Negative"])

def get_antibody_for_hbc_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantihbc", ["Positive", "Negative"])

def get_antibody_for_hcv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantihcv", ["Positive", "Negative"])

def get_antibody_for_cmv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donanticmv", ["Positive", "Negative"])

def get_antibody_for_ebv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantiebv", ["Positive", "Negative"])

def get_antibody_for_hiv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantihiv", ["Positive", "Negative"])

def get_antibody_for_toxo_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantitoxo", ["Positive", "Negative"])

def get_antibody_for_vzv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantivzv", ["Positive", "Negative"])

def get_antibody_for_hsv_antigen_donor(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    return get_categorical_feature_by_key(patient_ID, data, "donantihsv", ["Positive", "Negative"])
...
def get_immuno_test_results(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    # TODO: check if immunum or immumeth are useful
...
def get_initial_dialysis(patient_ID:int, data:pd.DataFrame) -> pd.DataFrame:
    ...
    return get_time_value_pairs(patient_ID, data, "dialysisdate", "dialysistype")
...
def pool_kidney_bl_data(
    ...
    kbl_dates = pd.concat([df.melt(var_name="attribute", value_name="time") for df in [
    ...
    ]], ignore_index=True).assign(time=pd.NaT)

    # Build longitudinal features dataframe
    kbl_longitudinals = pd.concat([
        get_initial_dialysis(patient_ID, kidney_bl_df),
        get_immuno_test_results(patient_ID, kidney_bl_df),
    ...
    patient_kbl_df = pd.concat([kbl_dates, kbl_statics, kbl_longitudinals], ignore_index=True)
